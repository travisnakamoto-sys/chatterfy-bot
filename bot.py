    ...
    try:
        ...
        claude_response = claude.messages.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"""Ти досвідчений sales-менеджер. Проаналізуй переписку та дай рекомендації.

ПЕРЕПИСКА:
{conversation_text}

Надай:
1. АНАЛІЗ — що відбувається, які проблеми у клієнта
2. СТРАТЕГІЯ — як вести далі діалог
3. ГОТОВІ ФРАЗИ — 2-3 варіанти що написати клієнту зараз
